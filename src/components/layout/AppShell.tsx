  ...
  return (
    <div className="min-h-dvh bg-background text-foreground">
      ...
      >
        ...
        {!hideHeader && !immersive && <SyncStatusIndicator />}
            ...
            {NAV_ITEMS.map(({ to, label, Icon }) => {
              ...
              return (
                <Link
                  ...
                  className={`flex min-h-14 flex-1 flex-col items-center justify-center gap-1 text-[10px] font-medium transition-colors ${
